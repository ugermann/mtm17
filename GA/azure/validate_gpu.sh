...
dev=$working_dir/hq.20170623.cs-en.dev.bpe.half.en
ref=$working_dir/hq.20170623.cs-en.dev.half.cs
...
THEANO_FLAGS=mode=FAST_RUN,floatX=float32,device=$device,on_unused_input=warn  python $nematus_home/nematus/translate.py \
    -p 1 --models $prefix   -i $dev -o $dev.output.dev -k 5 -n  
